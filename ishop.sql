...
--
-- Хост: 127.0.0.1:3306
-- Час створення: Сер 26 2018 р., 16:15
...
--
-- Структура таблиці `attribute_product`
--
...
--
-- Дамп даних таблиці `attribute_product`
--
...
--
-- Структура таблиці `attribute_value`
--
...
--
-- Дамп даних таблиці `attribute_value`
--
...
--
-- Структура таблиці `related_product`
--
...
--
-- Дамп даних таблиці `related_product`
--
...
--
-- Індекси таблиці `attribute_group`
--
ALTER TABLE `attribute_group`
  ADD PRIMARY KEY (`id`);

--
-- Індекси таблиці `attribute_product`
--
ALTER TABLE `attribute_product`
  ADD PRIMARY KEY (`attr_id`,`product_id`);

--
-- Індекси таблиці `attribute_value`
--
...
--
-- Індекси таблиці `related_product`
--
...
--
-- AUTO_INCREMENT для таблиці `attribute_group`
--
ALTER TABLE `attribute_group`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT для таблиці `attribute_value`
--
ALTER TABLE `attribute_value`
